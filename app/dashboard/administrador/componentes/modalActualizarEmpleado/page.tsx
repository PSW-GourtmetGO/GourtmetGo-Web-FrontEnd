...
const ModalUpdate: React.FC<ModalUpdate> = ({ isOpen, onClose }) => {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="text" id="cedula" name="cedula" value={formData.cedula} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="text" id="nombre" name="nombre" value={formData.nombre} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="text" id="apellido" name="apellido" value={formData.apellido} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso contenedorIngresoCalendario">
                                                <input type="date" id="fecha_Nacimiento" name="fecha_Nacimiento" value={formData.fecha_Nacimiento} onChange={handleInputChange} className="ingreso" required />
                                            </div>
                                        </div>
                                        <div className="ingresos">
                                            <label htmlFor="direccion" className="label">Dirección:</label>
                                            <div className="contenedorIngreso">
                                            <input type="text" id="direccion" name="direccion" value={formData.direccion} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="text" id="telefono" name="telefono" value={formData.telefono} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="email" id="correo" name="correo" value={formData.correo} onChange={handleInputChange} className="ingreso" required />
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input type="password" id="contrasenia" name="contrasenia" value={formData.contrasenia} onChange={handleInputChange} className="ingreso" required />
                                            </div>
                                        </div>
                                    </form>
                                </div>
