...
import ActualizarImgane from '../../../../../public/imagenes/actualizarImagen.svg'
    ...
    const ModalUpdate: React.FC<ModalUpdate> = ({ isOpen, onClose }) => {
        ...
        const validateForm = () => {
            ...
            // Validar correo
            if (!/[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$/.test(formData.correo)) {
                errors.correo = 'Introduce una dirección de correo válida';
                valid = false;
            }
                            ...
                            <div className="contenido">
                                <div className='formulario'>
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="ingresos">
                                            ...
                                            <div className="contenedorIngreso">
                                                <input
                                                    ...
                                                    required
                                                    minLength={2}
                                                    title="El apellido debe tener al menos 2 caracteres"
                                                />
                                        ...
                                        {/* Agrega mensajes de error para otros campos aquí */}
                                        <div className="ingresos">
