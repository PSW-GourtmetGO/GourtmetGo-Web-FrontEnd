                            ...
                            <div className='col-start-1'>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-4">
                                        ...
                                        <input type="text" id="nombre" name="nombre" value={formData.nombre} onChange={handleNombreChange} className="w-full rounded block mb-2 text-black border border-black" required />
                                    </div>
                                    <div className="mb-4">
                                ...
                                <div className="card">
                                    ...
                                    <div className="relative w-64 text-black border border-black">
                                        ...
                                        <div className="w-64 h-64 group hover:bg-gray-200 opacity-60 absolute flex justify-center items-center cursor-pointer transition duration-500" onClick={handleImageClick}>
                                            <Image className="hidden group-hover:block w-12" src={ActualizarImagen} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='grid grid-cols-2 w-full gap-x-6'>
                            <div className='col-start-1'>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-4">
                                        <label htmlFor="nombre" className="block text-gray-700 font-bold mb-2">Nombre:</label>
                                        <input type="text" id="platoNombre" name="platoNombre" value={Datos.platoNombre} onChange={handleNombreChangeEdit} className="w-full rounded block mb-2 text-black border border-black" required />
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="costo" className="block text-gray-700 font-bold mb-2">Costo:</label>
