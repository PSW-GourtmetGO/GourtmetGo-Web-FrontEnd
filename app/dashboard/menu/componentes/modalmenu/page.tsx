    ...
    const Modal: React.FC<ModalProps> = ({ isOpen, onClose, Datos, setData }) => {
        ...
        const handleNombreChange = (e: ChangeEvent<HTMLInputElement>) => {
            ...
            setNombreValido(value.trim().length >= 4 && formData.precio > 0);
        };
                    ...
                    <div className='contenedorModal'>
                        <div className="tarjetaModal">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div>
                                        ...
                                        <div className="contenedorIngreso">
                                            <input type="text" id="nombre" name="nombre" value={formData.nombre} onChange={handleNombreChange} className="ingreso" required={nombreValido} max={15} maxLength={15}/>
                                    ...
                                    <div>
                                        ...
                                        {!nombreValido && <p className="mensajeError text-red-500">El precio debe ser mayor a 0.</p>}
                                    </div>
                                    <div>
                            ...
                            <div className="botones">
                                <button type="submit" onClick={guardarPlato} className="botonVerde" disabled={!nombreValido}>Guardar</button>
                            </div>
                        </div>
                    </div>
                ) : (isOpen) ? (
